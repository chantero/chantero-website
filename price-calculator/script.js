function calculate() {
  ...
  const unitPerPrice3 = isNaN(price3) || isNaN(unit3) ? '' : (price3 / unit3).toFixed(5);
  ...
  document.getElementById('results3').innerHTML = `<strong>Price per Unit:</strong> ${unitPerPrice3}`;
